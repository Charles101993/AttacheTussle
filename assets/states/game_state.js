...
var game_state = {
	...
	preload: function(){
		...
		game.load.spritesheet('c4', 'assets/c5.png', 58.25, 74);
		game.load.spritesheet('c4_no_purse', 'assets/c5_no_purse.png', 58.25, 74);
		game.load.spritesheet('c4_onground', 'assets/c5_onground.png', 74.5, 74);
	...
	create: function(){
		...
		game.camera.x = 10;
		game.camera.height = game.world.height;
		game.camera.width = game.world.width;
		...
		var ledge = platforms.create(242, 302, 'ground');
		ledge.scale.setTo(.1, .1);
		ledge.body.immovable = true;
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(500, 255, 'ground');
		ledge.scale.setTo(.1 * deviceRatio, .1 * deviceRatio);
		ledge.body.immovable = true;
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(839, 323, 'ground');
		ledge.body.immovable = true;
		ledge.scale.setTo(.1* deviceRatio, .1* deviceRatio);
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(693, 272, 'ground');
		ledge.body.immovable = true;
		ledge.scale.setTo(.1* deviceRatio, .1* deviceRatio);
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(616, 177, 'ground');
		ledge.body.immovable = true;
		ledge.scale.setTo(.1* deviceRatio, .1* deviceRatio);
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(120, 212, 'ground');
		ledge.body.immovable = true;
		ledge.scale.setTo(.1 * deviceRatio, .1* deviceRatio);
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(179, 68, 'ground');
		ledge.body.immovable = true;
		ledge.scale.setTo(.1* deviceRatio,.1* deviceRatio);
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(297, 279, 'ground');
		ledge.body.immovable = true;
		ledge.scale.setTo(.1* deviceRatio,.1* deviceRatio);
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(457, 368, 'ground');
		ledge.body.immovable = true;
		ledge.scale.setTo(.1* deviceRatio,.1* deviceRatio);
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(417, 174, 'ground');
		ledge.body.immovable = true;
		ledge.scale.setTo(.1* deviceRatio,.1* deviceRatio);
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(458, 68, 'ground');
		ledge.body.immovable = true;
		ledge.scale.setTo(.1* deviceRatio,.1* deviceRatio);
		ledge.anchor.setTo(0.5, 0.5);
		ledge = platforms.create(748, 68, 'ground');
		ledge.body.immovable = true;
		ledge.scale.setTo(.1* deviceRatio,.1* deviceRatio);
		ledge.anchor.setTo(0.5, 0.5);
		...
		if(playerID == 'player 1'){
			...
			//  player score
			player_score_text = game.add.text(50, 10, String(player_score), { fontSize: '32px', fill: '#000' });
			//  opponent score
			opponent_score_text = game.add.text(750, 10, String(opponent_score), { fontSize: '32px', fill: '#000' });
		}
			...
			//  player score
			player_score_text = game.add.text(750, 10, String(player_score), { fontSize: '32px', fill: '#000' });
			//  opponent score
			opponent_score_text = game.add.text(50,10, String(opponent_score), { fontSize: '32px', fill: '#000' });
		}
		
		
		emitter1 = game.add.emitter(160, 420, 400);
		emitter2 = game.add.emitter(205, 405, 400);
		emitter3 = game.add.emitter(276.25, 420, 400);
		emitter4 = game.add.emitter(392.5, 405, 400);
		emitter5 = game.add.emitter(508.75, 420, 400);
		emitter6 = game.add.emitter(580, 405, 400);
		emitter7 = game.add.emitter(625, 420, 400);
		...
		s_listener_down = function(){
			s_button_down = true;
		}
		a_listener_down = function(){
			a_button_down = true;
		}
		d_listener_down = function(){
			d_button_down = true;
		}

		s_listener_up = function(){
			s_button_down = false;
		}
		a_listener_up = function(){
			a_button_down = false;
		}
		d_listener_up = function(){
			d_button_down = false;
		}
		if(this.game.device.desktop == true) {
			...
			a_button = game.add.sprite(775, 390, 'button');
			s_button = game.add.sprite(830, 365, 'button');
			d_button = game.add.sprite(865, 340, 'button');

			s_button.scale.setTo(2,2);
			a_button.scale.setTo(1.5,1.5);
			d_button.scale.setTo(1.5,1.5);
			...
			s_button.events.onInputDown.add(s_listener_down, this);
			a_button.events.onInputDown.add(a_listener_down, this);
			d_button.events.onInputDown.add(d_listener_down, this);

			s_button.events.onInputUp.add(s_listener_up, this);
			a_button.events.onInputUp.add(a_listener_up, this);
			d_button.events.onInputUp.add(d_listener_up, this);
			...
			if(p_or_o.purse == true){
				if(p_or_o == opponent){}
					...
					if(player_score > 6){
						...
						if(opponent_score > 6  || player_score > 6){
		...
		else
		{
			...
			*/
			...
			if(can_move == true){
				...
				else if((a_key.isDown || a_button_down) && player.dash == true){
					whoosh.play();
					l_dash();
					player.body.velocity.x = -600;
					game.time.events.add(Phaser.Timer.QUARTER *1, disable_dash, this);
				}
				else if((d_key.isDown || d_button_down) && player.dash == true){
					whoosh.play();
					r_dash();
					player.body.velocity.x = 600;
					game.time.events.add(Phaser.Timer.QUARTER *1, disable_dash, this);
